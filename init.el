...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(helm list-packages-ext helm-projectile helm-ag projectile avy color-identifiers-mode rainbow-delimiters cmake-ide rtags cl-lib flycheck-irony company-irony company-irony-c-headers company-anaconda anaconda-mode rjsx-mode s xref-js2 js2-refactor ag company-tern irony smartparens smart-tabs-mode emmet-mode expand-region company-web all-the-icons exec-path-from-shell json-mode color-theme-sanityinc-solarized color-theme-sanityinc-tomorrow swiper tss org omnisharp csharp-mode js2-mode tide company typescript-mode yasnippet-snippets web-mode flycheck auto-complete neotree try iedit cyberpunk-theme)))
