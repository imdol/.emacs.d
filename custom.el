(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (all-the-icons exec-path-from-shell omnisharp eldoc-eval json-mode json-reformat json-snatcher shrink-path web-completion-data cyberpunk-theme company-web emmet-mode benchmark-init pythonic anaconda-mode company-anaconda rjsx-mode async auto-complete csharp-mode dash epl f ghub git-commit graphql let-alist magit-popup memoize pkg-info popup pos-tip s shut-up treepy with-editor typescript-mode js2-mode smartparens neotree c-eldoc irony-eldoc flycheck-irony company-irony company-irony-c-headers irony yasnippet helm-projectile projectile iedit rainbow-delimiters multiple-cursors multi-term expand-region company-quickhelp cherry-blossom-theme))))
(custom-set-faces
