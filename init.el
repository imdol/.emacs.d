...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(company-quickhelp magit nodejs-repl common-lisp-snippets helm list-packages-ext helm-projectile helm-ag color-identifiers-mode cmake-ide rtags cl-lib flycheck-irony company-irony company-irony-c-headers company-anaconda anaconda-mode xref-js2 js2-refactor ag company-tern irony emmet-mode expand-region company-web all-the-icons exec-path-from-shell color-theme-sanityinc-solarized color-theme-sanityinc-tomorrow tss org omnisharp csharp-mode flycheck auto-complete neotree try iedit cyberpunk-theme)))
